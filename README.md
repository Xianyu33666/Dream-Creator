<!-- Language Switcher -->
<div align="right">
  <select id="lang-switch" onchange="switchLanguage(this.value)" style="padding: 5px 10px; border-radius: 5px; border: 1px solid #ddd; cursor: pointer;">
...
<!-- 简体中文 -->
<div lang="zh-CN" style="display: none;">
...
function switchLanguage(lang) {
  ...
  document.querySelectorAll('div[lang]').forEach(div => {
    div.style.display = 'none';
  });

  // Show selected language
  const selectedLang = document.querySelector(`div[lang="${lang}"]`);
  if (selectedLang) {
